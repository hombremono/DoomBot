...
public class AngularIntercept implements IShootingState
{

	public AngularIntercept ()
	{
		ContextData.getInstance().setShootActualState(ShootDictionary.AngularIntercept);
	}
